...
const DICT = {
  en: {
    ...
    label_octave: "Octave",
    label_volume: "Volume",
    label_voice: "Instrument",
    label_rhythm: "Rhythm",
    label_cam_opacity: "Camera",
    pad_zone_label: "Gesture Zone",
    label_pad_pos: "Zone",
    pad_pos_left: "Left",
    pad_pos_center: "Middle",
    pad_pos_right: "Right",
    label_ring_mode: "Ring",
    ring_mode_emotion: "Emotion",
    ring_mode_chord: "Chord",
    emotion_add9: "Happy",
    emotion_maj7: "Warm",
    emotion_sus4: "Hopeful",
    emotion_dim:  "Tense",
    emotion_min7: "Sad",
    emotion_dom7: "Blues",
    chord_sub_add9: "bright · 9th",
    chord_sub_maj7: "warm · maj 7",
    chord_sub_sus4: "floating · 4th",
    chord_sub_dim:  "tense · dim 7",
    chord_sub_min7: "mellow · min 7",
    chord_sub_dom7: "bluesy · dom 7",
    voice_piano: "Piano",
    voice_ep: "E-Piano",
    voice_acoustic: "Acoustic",
    voice_electric: "Electric",
    voice_pad: "Pad",
    btn_bass: "🎸 Bass",
    btn_drum: "🥁 Drum",
    ...
    btn_kbd_title: "Use computer keyboard as MIDI (click again to return to MIDI)",
    btn_kbd_active: "MIDI Mode",
    btn_kbd_active_title: "Back to external MIDI input",
    btn_kbd_active_status: "Computer keyboard enabled",
    btn_kbd_disabled_status: "Back to MIDI mode",
    ...
    help_close: "Got it",
    onboard_title: "Ready to play",
    onboard_subtitle: "Two hands. One plays notes. The other paints chords.",
    onboard_step1_b: "Play a root note",
    onboard_step1_t: "on your MIDI keyboard — this sets the chord's root.",
    onboard_step2_b: "Raise your other hand",
    onboard_step2_t: "into the camera view above the keyboard.",
    onboard_step3_b: "Move to pick a color",
    onboard_step3_t: "Center top = Major · Center bottom = minor · Outer ring = 6 tensions (Maj7, Add9, 7, m7, dim, sus4).",
    onboard_go: "Let's play",
  },
  zh: {
    ...
    emotion_min7: "忧郁",
    emotion_dom7: "蓝调",
    chord_sub_add9: "明亮·九度",
    chord_sub_maj7: "温暖·大七",
    chord_sub_sus4: "悬浮·四度",
    chord_sub_dim:  "紧张·减七",
    chord_sub_min7: "温柔·小七",
    chord_sub_dom7: "蓝调·属七",
    voice_piano: "钢琴",
    voice_ep: "电钢",
    voice_acoustic: "木吉他",
    voice_electric: "电吉他",
    ...
    btn_kbd: "键盘模式",
    btn_kbd_title: "用电脑键盘模拟琴键（再点一次切回 MIDI）",
    btn_kbd_active: "MIDI 模式",
    btn_kbd_active_title: "切回外接 MIDI 输入",
    btn_kbd_active_status: "电脑键盘已启用",
    btn_kbd_disabled_status: "已切回 MIDI 模式",
    ...
    help_close: "知道了",
    onboard_title: "开始玩吧",
    onboard_subtitle: "两只手 —— 一只弹琴，一只涂色。",
    onboard_step1_b: "一只手弹根音",
    onboard_step1_t: "在 MIDI 键盘上按一个单音 —— 它决定和弦的根。",
    onboard_step2_b: "另一只手抬起",
    onboard_step2_t: "进入键盘上方的摄像头画面。",
    onboard_step3_b: "移动选择和弦色彩",
    onboard_step3_t: "中心上半 = 大三 · 中心下半 = 小三 · 外环 6 区 = 色彩延伸（Maj7 · Add9 · 7 · m7 · dim · sus4）。",
    onboard_go: "开始",
  },
};
